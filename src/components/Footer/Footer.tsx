...
export const Footer = () => {
	return (
		<div className='font-montserrat text-sm text-center mt-auto mb-4 md:mb-0 md:text-white-100 leading-4 font-normal md:fixed md:bottom-5 md:left-1/2 md:-translate-x-1/2'>
			created by
			<a
